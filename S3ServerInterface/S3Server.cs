...
namespace S3ServerInterface
{
    ...
    public class S3Server : IDisposable
    {
        ...
        /// </summary>
        public Func<S3Response, S3Response> PostRequestHandler = null;
        ...
        private HttpResponse RequestHandler(HttpRequest req)
        {
            ...
            try
            {
                ...
                if (PreRequestHandler != null)
                {
                    ...
                    {
                        if (PostRequestHandler != null) s3resp = PostRequestHandler(s3resp);
                ...
                switch (s3req.Method)
                {
                    ...
                    default:
                        if (DefaultRequestHandler != null)
                        {
                            ...
                            if (PostRequestHandler != null) defaultResp = PostRequestHandler(defaultResp);
